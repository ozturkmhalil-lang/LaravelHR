	...
	<div class="page-wrapper">
		...
		<div class="content">
			...
			<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
				<div class="mb-2">
					<h6 class="fw-medium d-flex align-items-center"><a href="{{url('tickets')}}"><i
							...
							<div>
									...
									<div>
										<div class="d-flex align-items-center mb-3">
											<span class="avatar avatar-ld avatar-rounded me-2 flex-shrink-0"><img
													src="{{URL::asset('build/img/users/user-02.jpg')}}" alt="Img"></span>
											<div>
								...
								<div>
									<div>
										<div class="d-flex align-items-center mb-3">
											<span class="avatar avatar-lg avatar-rounded me-2 flex-shrink-0"><img
													src="{{URL::asset('build/img/profiles/avatar-22.jpg')}}" alt="Img"></span>
											<div>
												<h6 class="mb-1">Marilyn Siegle</h6>
						...
						<div class="card-body p-0">
							...
							<div class="d-flex align-items-center border-bottom p-3">
								<span class="avatar avatar-md me-2 flex-shrink-0"><img
										src="{{URL::asset('build/img/users/user-01.jpg')}}" class="rounded-circle" alt="Img"></span>
								<div>
