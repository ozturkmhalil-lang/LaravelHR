				...
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
					<div class="me-2 mb-2">
						<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
							<a href="{{url('employees')}}" class="btn btn-icon btn-sm me-1"><i
									class="ti ti-list-tree"></i></a>
							<a href="{{url('employees-grid')}}"
							...
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{url('employee-details')}}"
										...
										<img src="{{URL::asset('build/img/users/user-32.jpg')}}" class="img-fluid h-auto w-auto"
											alt="img">
									</a>
								</div>
								<div class="dropdown">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center mb-3">
								...
								<span class="badge badge-secondary-transparent fs-10 fw-medium">Full Stack
									Developer</span>
							</div>
							<div class="row text-center">
								<div class="col-4">
						...
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{url('employee-details')}}"
										class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{URL::asset('build/img/users/user-31.jpg')}}" class="img-fluid h-auto w-auto"
											alt="img">
									</a>
								</div>
								<div class="dropdown">
