							...
							<div class="p-3">
								...
								<div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
									<div class="toast-header">
										<img src="{{URL::asset('build/img/logo-small.svg')}}" alt="brand-logo" height="16"
											class="me-1">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="card card-h-100">
						...
						<div class="card-body">
							<p class="text-muted">Alternatively, you can also add additional controls and components
								to toasts.</p>
