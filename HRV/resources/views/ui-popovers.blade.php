			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card card-h-100">
						...
						<div class="card-body">
							<p>Use the attribute <code>data-bs-trigger="hover"</code> to show the popover on
								hovering the element.</p>
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p>You can customize the appearance of popovers using CSS variables. We set a custom
								class with <code>data-bs-custom-class="popover-primary"</code> to scope our custom
