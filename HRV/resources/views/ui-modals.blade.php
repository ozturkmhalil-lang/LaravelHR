									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<button type="button" class="btn-close" data-bs-dismiss="modal"
												aria-label="Close"><i class="ti ti-circle-x"></i></button>
										</div>
					...
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Specify the position for the modal. You can display modal at top,
								bottom, or center of page by specifying classes <code>modal-top</code>,
								<code>modal-bottom</code>and <code>modal-dialog-centered</code>respectively.
							</p>
										...
										<div class="modal-body">
											<div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
												<a href="{{url('index')}}" class="logo-dark">
													<span><img src="{{URL::asset('build/img/logo.svg')}}" alt="dark logo"></span>
												</a>
												<a href="{{url('index')}}" class="logo-light">
													<span><img src="{{URL::asset('build/img/logo-white.svg')}}" alt="logo"></span>
												</a>
											</div>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-body">
											<div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
												<a href="{{url('index')}}" class="logo-dark">
													<span><img src="{{URL::asset('build/img/logo.svg')}}" alt="dark logo"
															height="22"></span>
												</a>
												<a href="{{url('index')}}" class="logo-light">
													<span><img src="{{URL::asset('build/img/logo-white.svg')}}" alt="logo"
															height="22"></span>
												</a>
											</div>
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Modal with header, body and footer having contexual background
								color.</p>
					...
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Have a bunch of buttons that all trigger the same modal with
								slightly different contents? Use <code>event.relatedTarget</code> and <a
									href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes"
									target="_blank">HTML <code>data-bs-*</code> attributes</a> to vary the contents
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p>Tooltips and popovers can be placed within modals as needed. When modals are closed,
								any tooltips and popovers within are also automatically dismissed.</p>
							...
							<div class="modal fade" id="exampleModalPopovers" tabindex="-1"
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h1 class="modal-title" id="exampleModalPopoversLabel">Modal title</h1>
											<button type="button" class="btn-close" data-bs-dismiss="modal"
												aria-label="Close"><i class="ti ti-circle-x"></i></button>
										</div>
										<div class="modal-body">
											...
											<p class="mb-0"><a href="#" class="text-primary"
													data-bs-toggle="tooltip" title="Tooltip">This link</a> and <a
