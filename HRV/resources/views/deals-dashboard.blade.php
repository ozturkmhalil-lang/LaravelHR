								...
								<div class="row g-2 justify-content-center">
									<div class="col-md col-sm-4 col-6">
										<div class="border rounded text-start p-2">
											<p class="mb-1"><i class="ti ti-point-filled text-primary"></i>Marketing
											</p>
											<h6>$5,221,45</h6>
										</div>
									</div>
									...
									<div class="col-md col-sm-4 col-6">
										<div class="border rounded text-start p-2">
											<p class="mb-1"><i
													class="ti ti-point-filled text-primary"></i>Operational</p>
											<h6>$10,557</h6>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-6">
							<div class="card border-white border-2 overlay-bg-3 position-relative">
								<div class="card-body">
									...
									<p class="fw-medium fs-13"><span class="text-danger fs-12"><i
												class="ti ti-arrow-wave-right-up me-1"></i>-4.01% </span> from last
										week</p>
								</div>
							</div>
							<div class="card border-white border-2 overlay-bg-3 position-relative">
							...
							<div class="card border-white border-2 overlay-bg-3 position-relative">
								<div class="card-body">
									...
									<div class="progress progress-xs mb-2">
										<div class="progress-bar bg-pink" role="progressbar" style="width: 40%">
										</div>
									</div>
									<p class="fw-medium fs-13"><span class="text-success fs-12"><i
						...
						<div class="col-sm-6">
							...
							<div class="card border-white border-2 overlay-bg-3 position-relative">
								<div class="card-body">
									...
									<p class="fw-medium fs-13"><span class="text-danger fs-12"><i
												class="ti ti-arrow-wave-right-up me-1"></i>-6.01% </span> from last
										week</p>
								</div>
							</div>
							<div class="card border-white border-2 overlay-bg-3 position-relative">
								<div class="card-body">
									...
									<p class="fw-medium fs-13"><span class="text-danger fs-12"><i
												class="ti ti-arrow-wave-right-up me-1"></i>-3.22% </span> from last
										week</p>
								</div>
							</div>
						</div>
									...
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												...
												<img src="{{URL::asset('build/img/company/company-24.svg')}}"
													class="w-auto h-auto p-1" alt="Img">
											</a>
											<div>
								...
								<div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
												<img src="{{URL::asset('build/img/company/company-25.svg')}}" class="w-auto h-auto"
													alt="Img">
											</a>
											<div>
								...
								<div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
												<img src="{{URL::asset('build/img/company/company-26.svg')}}" class="w-auto h-auto"
													alt="Img">
											</a>
											<div>
								...
								<div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
												<img src="{{URL::asset('build/img/company/company-27.svg')}}" class="w-auto h-auto"
													alt="Img">
											</a>
											<div>
								...
								<div class="border border-dashed bg-transparent-light rounded p-2">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
												<img src="{{URL::asset('build/img/company/company-28.svg')}}" class="w-auto h-auto"
													alt="Img">
											</a>
											<div>
						...
						<div class="card-body">
							...
							<div>
								...
								<div class="d-flex align-items-center justify-content-between mb-2">
									<p class="f-13 mb-0"><i
											class="ti ti-circle-filled text-primary me-1"></i>Marketing</p>
									<p class="f-13 fw-medium text-gray-9">$5,69,877</p>
								</div>
								<div class="d-flex align-items-center justify-content-between mb-2">
									<p class="f-13 mb-0"><i class="ti ti-circle-filled text-secondary me-1"></i>Chat
									</p>
									<p class="f-13 fw-medium text-gray-9">$4,84,575</p>
								</div>
								<div class="d-flex align-items-center justify-content-between">
									<p class="f-13 mb-0"><i class="ti ti-circle-filled text-warning me-1"></i>Email
									</p>
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center mb-2">
													<a href="{{url('countries')}}"
														...
														<img src="{{URL::asset('build/img/payment-gateway/country-01.svg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium mb-1"><a href="{{url('countries')}}">USA</a>
														</h6>
											...
											<td>
												<div class="text-center mb-2">
													<span class="country-chart-1"
														data-width="100%">0,3,0,2,1,3,1</span>
												</div>
											</td>
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center mb-2">
													<a href="{{url('countries')}}"
														class="avatar rounded-circle border border-2">
														<img src="{{URL::asset('build/img/payment-gateway/country-02.svg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium mb-1"><a href="{{url('countries')}}">UAE</a>
														</h6>
														<span class="fs-13 d-inline-flex align-items-center">Deals :
															221</span>
													</div>
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center mb-2">
													<a href="{{url('countries')}}"
														class="avatar rounded-circle border border-2">
														<img src="{{URL::asset('build/img/payment-gateway/country-03.svg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium mb-1"><a
																href="{{url('countries')}}">Singapore</a></h6>
														<span class="fs-13 d-inline-flex align-items-center">Deals :
															236</span>
													</div>
												</div>
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center mb-2">
													<a href="{{url('countries')}}"
														class="avatar rounded-circle border border-2">
														<img src="{{URL::asset('build/img/payment-gateway/country-04.svg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium mb-1"><a
																href="{{url('countries')}}">France</a></h6>
														<span class="fs-13 d-inline-flex align-items-center">Deals :
															589</span>
													</div>
												</div>
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center">
													<a href="{{url('countries')}}"
														class="avatar rounded-circle border border-2">
														<img src="{{URL::asset('build/img/payment-gateway/country-05.svg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium mb-1"><a
																href="{{url('countries')}}">Norway</a></h6>
														<span class="fs-13 d-inline-flex align-items-center">Deals :
															221</span>
													</div>
												</div>
							...
							<div class="table-responsive">
								<table class="table table-nowrap dashboard-table mb-0">
									...
									<tbody>
										<tr>
											<td>
												<h6 class="fw-medium"><a href="{{url('deals-details')}}">Collins</a></h6>
											</td>
										...
										<tr>
											<td>
												<h6 class="fw-medium"><a href="{{url('deals-details')}}">Konopelski</a>
												</h6>
											</td>
											<td>Proposal Made</td>
											<td>
										...
										<tr>
											<td>
												<h6 class="fw-medium"><a href="{{url('deals-details')}}">Adams</a></h6>
											</td>
											<td>Contact Made</td>
											<td>
												$8,40,000
										...
										<tr>
											<td>
												<h6 class="fw-medium"><a href="{{url('deals-details')}}">Schumm</a></h6>
											</td>
											<td>Quality To Buy</td>
											<td>
												$6,10,000
										...
										<tr>
											<td>
												<h6 class="fw-medium"><a href="{{url('deals-details')}}">Wisozk</a></h6>
											</td>
											<td>Presentation</td>
											<td>
												$4,70,000
								...
								<div class="flex-fill ps-3 timeline-flow">
									<p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}"
											class="d-flex align-items-center">Meeting With <img
												src="{{URL::asset('build/img/users/user-58.jpg')}}"
