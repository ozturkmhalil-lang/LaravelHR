							...
							<div class="row g-2 justify-content-center mb-3">
								<div class="col-md col-sm-4 col-6">
									<div class="border rounded p-2">
										<p class="mb-1 d-flex align-items-center gap-1"><i
												class="ti ti-square-rounded-filled text-primary fs-13"></i>Contacted
										</p>
										<h6>50000</h6>
									</div>
								</div>
								<div class="col-md col-sm-4 col-6">
									<div class="border rounded p-2">
										<p class="mb-1 d-flex align-items-center gap-1"><i
												class="ti ti-square-rounded-filled text-secondary fs-13"></i>Oppurtunity
										</p>
										<h6>25985</h6>
									</div>
								</div>
								<div class="col-md col-sm-4 col-6">
									<div class="border rounded p-2">
										<p class="mb-1 d-flex align-items-center gap-1"><i
												class="ti ti-square-rounded-filled text-info fs-13"></i>Not
											Contacted</p>
										<h6>12566</h6>
									</div>
								</div>
								...
								<div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
									<div class="d-flex align-items-center justify-content-between">
										<div class="d-flex align-items-center">
											<a href="javascript:void(0);"
												class="avatar rounded-circle bg-white border flex-shrink-0 me-2">
												<img src="{{URL::asset('build/img/company/company-24.svg')}}" class="w-auto h-auto"
													alt="Img">
											</a>
											<div>
					...
					<div class="card flex-fill">
						...
						<div class="card-body">
							<div class="d-flex align-items-start mb-4">
								<a href="javascript:void(0);" class="avatar flex-shrink-0">
									<img src="{{URL::asset('build/img/users/user-27.jpg')}}" class="rounded-circle border border-2"
										alt="img">
								</a>
								<div class="ms-2">
									...
									<div class="d-flex align-items-center">
										<a href="#" class="avatar avatar-sm border flex-shrink-0 me-2"><img
												src="{{URL::asset('build/img/social/pdf-icon.svg')}}" class="w-auto h-auto"
												alt="Img"></a>
							...
							<div class="d-flex align-items-start mb-4">
								<a href="javascript:void(0);" class="avatar flex-shrink-0">
									<img src="{{URL::asset('build/img/users/user-28.jpg')}}" class="rounded-circle border border-2"
										alt="img">
								</a>
								<div class="ms-2">
									<h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to
							...
							<div class="d-flex align-items-start mb-4">
								<a href="javascript:void(0);" class="avatar flex-shrink-0">
									<img src="{{URL::asset('build/img/users/user-29.jpg')}}" class="rounded-circle border border-2"
										alt="img">
								</a>
								<div class="ms-2">
									<h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to
							...
							<div class="d-flex align-items-start">
								<a href="javascript:void(0);" class="avatar flex-shrink-0">
									<img src="{{URL::asset('build/img/users/user-33.jpg')}}" class="rounded-circle border border-2"
										alt="img">
								</a>
								<div class="ms-2">
									<h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to
												...
												<div class="d-flex align-items-center file-name-icon">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('company-details')}}">BrightWave</a></h6>
													</div>
												</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center file-name-icon">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('company-details')}}">Stellar</a></h6>
													</div>
												</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center file-name-icon">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('company-details')}}">Quantum</a></h6>
													</div>
												</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center file-name-icon">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('company-details')}}">EcoVision</a></h6>
													</div>
												</div>
											</td>
											<td>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center file-name-icon">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('company-details')}}">Aurora</a></h6>
													</div>
												</div>
											</td>
											<td>
