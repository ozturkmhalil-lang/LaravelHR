			...
			<div class="row">
				...
				<div class="col-xl-12">
					...
					<div class="card">
						...
						<div class="card-body">
							<p>Change the appearance of offcanvases with utilities to better match them to different
								contexts like dark navbars. Here we add <code>.text-bg-dark</code> to the
								<code>.offcanvas</code> and <code>.btn-close-white</code> to <code>.btn-close</code>
								for proper styling with a dark offcanvas. If you have dropdowns within, consider
								also adding <code>.dropdown-menu-dark</code> to <code>.dropdown-menu</code>.
							</p>
							<div>
								<button class="btn btn-primary mt-2 mt-md-0" type="button"
								...
								<div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDark"
									...
									<div class="offcanvas-header">
										...
										<button type="button" class="btn-close text-light ms-auto"
