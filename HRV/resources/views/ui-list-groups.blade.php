			...
			<div class="row">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<ul class="list-group">
								...
								<li class="list-group-item">
									<i class="ti ti-brand-nextcloud me-1 align-middle fs-18"></i> Nextcloud File
									Sharing
								</li>
								<li class="list-group-item">
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Add <code>.active</code> to a <code>.list-group-item</code> to
			...
			<div class="row">
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Use <code>&lt;a&gt;</code>s or <code>&lt;button&gt;</code>s to
								create <em>actionable</em> list group items with hover, disabled, and active states
								by adding <code>.list-group-item-action</code>.</p>
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Add <code>.list-group-flush</code> to remove some borders and
								rounded corners to render list group items edge-to-edge in a parent container (e.g.,
								cards).</p>
							<ul class="list-group list-group-flush">
								<li class="list-group-item"><i
										class="ti ti-brand-slack me-1 align-middle fs-18"></i> Slack Collaboration
								</li>
								<li class="list-group-item"><i
										class="ti ti-brand-nextcloud me-1 align-middle fs-18"></i> Nextcloud File
									Sharing</li>
								<li class="list-group-item"><i class="ti ti-brand-zoom me-1 align-middle fs-18"></i>
									Zoom Video Meetings</li>
								<li class="list-group-item"><i
										class="ti ti-brand-notion me-1 align-middle fs-18"></i> Notion Workspace
								</li>
								<li class="list-group-item"><i
										class="ti ti-brand-stripe me-1 align-middle fs-18"></i> Stripe Billing
									System</li>
							</ul>
						</div> <!-- end card body -->
					</div> <!-- end card -->
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Numbers are generated by <code>counter-reset</code> on the
								<code>&lt;ol&gt;</code>, and then styled and placed with a <code>::before</code>
								psuedo-element on the <code>&lt;li&gt;</code> with <code>counter-increment</code>
			...
			<div class="row">
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted">Add nearly any HTML within, even for linked list groups like the
								one below, with the help of flexbox utilities.</p>
			...
			<div class="row">
					...
					<div class="card card-h-100">
						...
						<div class="card-body">
							<p>Add <code>.list-group-horizontal</code> to change the layout of list group items from
								...
								variant <code>.list-group-horizontal-{sm|md|lg|xl|xxl}</code> to make a list group
								horizontal starting at that breakpoint’s <code>min-width</code>.</p>
				...
				<div class="col-xl-4">
					<div class="card card-h-100">
						...
						<div class="card-body">
							<p class="text-muted">Add badges to any list group item to show unread counts, activity,
								and more with the help of some utilities.</p>
				...
				<div class="col-xl-4">
					<div class="card card-h-100">
						...
						<div class="card-body">
							<p class="text-muted">Place Bootstrap’s checkboxes and radios within list group items
