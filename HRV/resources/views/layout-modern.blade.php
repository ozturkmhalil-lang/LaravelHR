		...
		<div class="content">
			...
			<div class="card border-0">
				<div class="card-body d-flex align-items-center justify-content-between flex-wrap pb-1">
					...
					<div class="d-flex align-items-center flex-wrap mb-1">
						<a href="#" class="btn btn-white me-2 mb-2" data-bs-toggle="modal"
			...
			<div class="row">
								...
								<div class="row gx-0">
									<div class="col-6">
										<div class="p-2 flex-fill border-end border-bottom">
											<p class="fs-13 mb-2"><i
													class="ti ti-square-rounded-filled text-primary fs-12 me-2"></i>Fulltime
									...
									<div class="col-6">
										<div class="p-2 flex-fill border-bottom text-end">
											<p class="fs-13 mb-2"><i
													class="ti ti-square-rounded0filled me-2 text-secondary fs-12"></i>Contract
									...
									<div class="col-6">
										<div class="p-2 flex-fill border-end">
											<p class="fs-13 mb-2"><i
													class="ti ti-square-rounded-filled me-2 text-danger fs-12"></i>Probation
									...
									<div class="col-6">
										<div class="p-2 flex-fill text-end">
											<p class="fs-13 mb-2"><i
													class="ti ti-square-rounded-filled text-pink me-2 fs-12"></i>WFH
												<span class="text-gray-9">(20%)</span>
											</p>
							...
							<div
								...
								<div class="d-flex align-items-center overflow-hidden">
									...
									<a href="{{url('employee-details')}}" class="avatar avatar-md me-2">
										<img src="{{URL::asset('build/img/profiles/avatar-24.jpg')}}"
											class="rounded-circle border border-white" alt="img">
									</a>
									<div>
										<h6 class="text-truncate mb-1 fs-14 fw-medium"><a
												href="{{url('employee-details')}}">Daniel Esbella</a></h6>
					...
					<div class="card flex-fill">
						...
						<div class="card-body">
							...
							<div
								...
								<a href="{{url('leaves')}}" class="fs-13 link-primary text-decoration-underline mb-2">View
									Details</a>
							</div>
						</div>
					</div>
				...
				<div class="col-xxl-4 col-xl-6 d-flex">
					<div class="card flex-fill">
						<div
							class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap gap-2">
						...
						<div class="card-body">
							...
							<a href="{{url('attendance-report')}}" class="btn btn-light btn-md w-100">View All
								Attendance</a>
						</div>
					</div>
				</div>
							...
							<div class="tab-content">
								<div class="tab-pane fade" id="openings">
									...
									<div class="d-flex align-items-center justify-content-between mb-4">
										<div class="d-flex align-items-center">
											<a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
												<img src="{{URL::asset('build/img/icons/php.svg')}}" class="img-fluid w-auto h-auto"
													alt="img">
											</a>
											<div class="ms-2 overflow-hidden">
												<p class="text-dark fw-medium text-truncate mb-0"><a
									...
									<div class="d-flex align-items-center justify-content-between mb-0">
										<div class="d-flex align-items-center">
											<a href="#" class="avatar overflow-hidden flex-shrink-0 bg-gray-100">
												<img src="{{URL::asset('build/img/icons/laravel-icon.svg')}}"
													class="img-fluid w-auto h-auto" alt="img">
											</a>
											<div class="ms-2 overflow-hidden">
												<p class="text-dark fw-medium text-truncate mb-0"><a
					...
					<div class="card flex-fill">
						<div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
							...
							<div class="d-flex align-items-center">
								<div class="dropdown mb-2">
									<a href="javascript:void(0);"
										class="dropdown-toggle dropdown-sm btn btn-white border-0 btn-sm d-inline-flex align-items-center fs-13 me-2"
										data-bs-toggle="dropdown">
										All Departments
									</a>
									<ul class="dropdown-menu  dropdown-menu-end p-3">
							...
							<div class="d-flex align-items-center justify-content-between flex-wrap">
								<div class="d-flex align-items-center mb-1">
									<p class="fs-13 text-gray-9 me-3 mb-0"><i
											class="ti ti-square-rounded-filled me-2 text-primary"></i>Income</p>
									<p class="fs-13 text-gray-9 mb-0"><i
											class="ti ti-square-rounded-filled me-2 text-gray-2"></i>Expenses</p>
								</div>
					...
					<div class="card flex-fill">
						<div class="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
							...
							<div class="d-flex align-items-center">
								<div class="dropdown mb-2">
									<a href="javascript:void(0);"
										class="dropdown-toggle dropdown-sm btn btn-white btn-sm d-inline-flex align-items-center fs-13 me-2 border-0"
										data-bs-toggle="dropdown">
										Invoices
									</a>
									<ul class="dropdown-menu  dropdown-menu-end p-3">
									...
									<tbody>
												...
												<div class="d-flex align-items-center">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('invoice-details')}}">Redesign Website</a>
														</h6>
														<span
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a href="{{url('invoice-details')}}">Module
																Completion</a></h6>
														<span
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center">
													<a href="{{url('invoice-details')}}" class="avatar">
														<img src="{{URL::asset('build/img/users/user-55.jpg')}}"
															class="img-fluid rounded-circle" alt="img">
													</a>
													<div class="ms-2">
														<h6 class="fw-medium"><a href="{{url('invoice-details')}}">Change
																on Emp Module</a></h6>
														<span
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a href="{{url('invoice-details')}}">Changes
																on the Board</a></h6>
														<span
															class="fs-13 d-inline-flex align-items-center">#INVOO2<i
																class="ti ti-circle-filled fs-4 mx-1 text-primary"></i>Ignis
										...
										<tr>
											<td class="px-0">
												<div class="d-flex align-items-center">
													...
													<div class="ms-2">
														<h6 class="fw-medium"><a
																href="{{url('invoice-details')}}">Hospital Management</a>
														</h6>
														<span
								...
								<table class="table table-nowrap mb-0">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="avatar-list-stacked avatar-group-sm">
													...
													<span class="avatar avatar-rounded">
														<img class="border border-white"
															src="{{URL::asset('build/img/profiles/avatar-09.jpg')}}" alt="img">
													</span>
												</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<h6 class="fw-medium"><a href="{{url('project-details')}}">Travel Planning
														Website</a></h6>
											</td>
											<td>
												<div class="avatar-list-stacked avatar-group-sm">
													<span class="avatar avatar-rounded">
														<img class="border border-white"
															src="{{URL::asset('build/img/profiles/avatar-17.jpg')}}" alt="img">
													</span>
													<span class="avatar avatar-rounded">
														<img class="border border-white"
										...
										<tr>
											...
											<td>
												<h6 class="fw-medium"><a href="{{url('project-details')}}">Service Booking
														Software</a></h6>
											</td>
											<td>
												<div class="avatar-list-stacked avatar-group-sm">
				...
				<div class="col-xxl-4 col-xl-5 d-flex">
					<div class="card flex-fill">
						...
						<div class="card-body">
							...
							<div
								class="bg-dark br-5 p-3 pb-0 d-flex align-items-center justify-content-between hrs-card">
								<div class="mb-2">
						...
						<div class="card-body">
							<div class="bg-light p-3 br-5 mb-4">
								...
								<div class="d-flex align-items-center justify-content-between border-top mt-2 pt-3">
									<div class="avatar-list-stacked avatar-group-sm">
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="{{URL::asset('build/img/users/user-49.jpg')}}"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="{{URL::asset('build/img/users/user-13.jpg')}}"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="{{URL::asset('build/img/users/user-11.jpg')}}"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="{{URL::asset('build/img/users/user-22.jpg')}}"
												alt="img">
										</span>
										<span class="avatar avatar-rounded">
											<img class="border border-white" src="{{URL::asset('build/img/users/user-58.jpg')}}"
												alt="img">
										</span>
										<a class="avatar bg-primary avatar-rounded text-fixed-white fs-10 fw-medium"
											href="javascript:void(0);">
						...
						<div class="card-body pb-1">
							...
							<div class="p-2 border border-dashed rounded mb-3 birthday-card active">
								<div class="d-flex align-items-center justify-content-between">
									...
									<a href="javascript:void(0);"
										class="btn btn-sm btn-white flex-shrink-0 border-0"><i
							...
							<div class="p-2 border border-dashed rounded mb-3 birthday-card">
								<div class="d-flex align-items-center justify-content-between">
									...
									<a href="javascript:void(0);" class="btn btn-sm btn-white flex-shrink-0"><i
											class="ti ti-cake me-1"></i>Send</a>
								</div>
							</div>
							<div class="p-2 border border-dashed rounded mb-3 birthday-card">
							...
							<div class="p-2 border border-dashed rounded mb-3 birthday-card">
								<div class="d-flex align-items-center justify-content-between">
									...
									<a href="javascript:void(0);" class="btn btn-sm flex-shrink-0 btn-white"><i
											class="ti ti-cake me-1"></i>Send</a>
								</div>
							</div>
						</div>
