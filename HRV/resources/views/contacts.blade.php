				...
				<div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
					<div class="me-2 mb-2">
						<div class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
							<a href="{{url('contacts')}}" class="btn btn-icon btn-sm active bg-primary text-white me-1"><i
									class="ti ti-list-tree"></i></a>
							<a href="{{url('contacts-grid')}}" class="btn btn-icon btn-sm"><i
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Sharon Roy</a>
												</h6>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Dawn Mercha</a>
												</h6>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Rachel
														Hampton</a></h6>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Jonelle
														Curtiss</a></h6>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Jonathan
														Smith</a></h6>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center file-name-icon">
											...
											<div class="ms-2">
												<h6 class="fw-medium"><a href="{{url('contact-details')}}">Patricia
														Carter</a></h6>
												<span class="fs-12 fw-normal ">Team Lead Dev</span>
											</div>
										</div>
