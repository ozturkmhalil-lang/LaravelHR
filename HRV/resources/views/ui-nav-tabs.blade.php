					...
					<div class="card">
						...
						<div class="card-body">
							<ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
								<li class="nav-item">
									<a href="#home2" data-bs-toggle="tab" aria-expanded="false"
								...
								<li class="nav-item">
									<a href="#messages2" data-bs-toggle="tab" aria-expanded="false"
										class="nav-link rounded-0">
										Settings
									</a>
								</li>
								...
								<div class="col-sm-9">
									<div class="tab-content" id="v-pills-tabContent">
										<div class="tab-pane fade active show" id="v-pills-home" role="tabpanel"
											...
											<p class="mb-0">Welcome to the dashboard! Access key metrics, recent
										...
										<div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
											...
											<p class="mb-0">Manage your profile details, update your contact info,
										...
										<div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
											...
											<p class="mb-0">View recent messages, send new replies, and stay
						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-sm-3 mt-2 mt-sm-0">
									<div class="nav flex-column nav-pills nav-pills-secondary gap-2"
										...
										<a class="nav-link" id="v-pills-messages-tab2" data-bs-toggle="pill"
