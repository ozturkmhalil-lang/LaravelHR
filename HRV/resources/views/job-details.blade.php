								...
								<div class="row align-items-center">
									<div class="col-xl-9 col-md-8">
										<div class="d-flex align-items-center mb-3">
											<a href="#" class="me-2">
												<span class="avatar avatar-lg bg-gray"><img src="{{URL::asset('build/img/icons/apple.svg')}}"
								...
								<div class="row align-items-center">
									...
									<div class="col-xl-3 col-md-4">
										<div class="d-flex align-items-center justify-content-end">
											...
											<a href="#" class="btn btn-icon bg-transparent-dark"><i
										...
										<div class="row gy-4">
											<div class="col-xl-3 col-md-4 col-sm-6">
												<div class="d-flex align-items-center">
													<span
														class="avatar avatar-lg bg-primary-transparent flex-shrink-0 me-2">
								...
								<div class="d-flex align-items-center mb-4">
									...
									<div class="d-flex align-items-center">
										<a href="#" class="btn border btn-light-500 me-3"><img
												src="{{URL::asset('build/img/social/google.svg')}}" alt="Img"></a>
										<a href="#" class="btn border btn-light-500 me-3"><img
												src="{{URL::asset('build/img/social/facebook.svg')}}" alt="Img"></a>
										<a href="#" class="btn border btn-light-500 me-3"><img
												src="{{URL::asset('build/img/social/twitter.svg')}}" alt="Img"></a>
									</div>
								</div>
							</div>
													...
													<div class="d-flex align-items-center">
														<a href="#" class="me-2">
															<span class="avatar avatar-lg bg-gray"><img
																	...
																	alt="icon"></span></a>
														<div>
															<h6 class="fw-medium mb-1 text-truncate"><a href="#">React
																	Developer </a></h6>
