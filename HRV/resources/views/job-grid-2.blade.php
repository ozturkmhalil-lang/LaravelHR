					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xxl-9 col-lg-8">
								...
								<div
									class="d-md-flex d-block align-items-center justify-content-between border-bottom pb-1 mb-3">
									<div class="mb-2">
										<h5>Total Jobs (68)</h5>
									</div>
									<div class="d-flex right-content align-items-center flex-wrap">
										...
										<div class="me-2 mb-2">
											<div
												class="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
												<a href="{{url('job-list-2')}}" class="btn btn-icon btn-sm me-1"><i
														class="ti ti-list-tree"></i></a>
												<a href="{{url('job-grid-2')}}"
													class="btn btn-icon btn-sm active bg-dark text-white"><i
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															...
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Senior IOS Developer</a>
																</h6>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															...
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Junior PHP Developer</a>
																</h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/black.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Network Engineer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/react.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">React Developer </a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/laravel.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Laravel Developer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/devops.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">DevOps Engineer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/android.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Android Developer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/html.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">HTML Developer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															...
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">UI/UX Designer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/grafic.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Senior IOS Developer</a>
												...
												<div class="card bg-light">
													<div class="card-body p-3">
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray"><img
																		src="{{URL::asset('build/img/icons/angular.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Angular Developer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
														...
														<div class="d-flex align-items-center">
															<a href="{{url('job-details')}}" class="me-2">
																<span class="avatar avatar-lg bg-gray-100"><img
																		src="{{URL::asset('build/img/icons/nodejs.svg')}}"
																		class="w-auto h-auto" alt="icon"></span></a>
															<div>
																<h6 class="fw-medium mb-1 text-truncate"><a
																		href="{{url('job-details')}}">Node js Developer</a></h6>
																<p class="fs-12 text-gray fw-normal">25 Applicants</p>
															</div>
														</div>
													</div>
