				...
				<div class="row">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="d-flex flex-wrap gap-2">
									...
									<div class="btn-group">
										<button type="button" class="btn btn-soft-success dropdown-toggle"
											data-bs-toggle="dropdown" aria-expanded="false">
											Success
										</button>
										<ul class="dropdown-menu">
									...
									<div class="btn-group">
										<button type="button" class="btn btn-soft-warning dropdown-toggle"
											data-bs-toggle="dropdown" aria-expanded="false">
											Warning
										</button>
										<ul class="dropdown-menu">
									...
									<div class="btn-group">
										<button type="button" class="btn btn-soft-danger dropdown-toggle"
											data-bs-toggle="dropdown" aria-expanded="false">
											Danger
										</button>
										<ul class="dropdown-menu">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="d-flex flex-wrap gap-2">
									...
									<div class="btn-group">
										<button type="button" class="btn btn-soft-info dropdown-toggle rounded-pill"
											data-bs-toggle="dropdown" aria-expanded="false">
											Info
										</button>
										<ul class="dropdown-menu">
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">Add <code>.active</code> to item in the dropdown to
							...
							<div class="card-body">
								...
								<div class="dropdown-center">
									...
									<ul class="dropdown-menu" aria-labelledby="dropdownCenterBtn">
										...
										<li><a class="dropdown-item" href="javascript:void(0);">Action three</a>
										</li>
									</ul>
								</div>
							</div> <!-- end card body -->
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted mb-3">Use <code>.dropup-center</code> on the parent element.
								</p>
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p>You can use the <code>autoClose</code> option to change this behavior of the
									dropdown.</p>
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">To align <strong>right</strong> the dropdown menu with the
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">To align <strong>left</strong> the dropdown menu with the
									given breakpoint or larger, add <code>.dropdown-menu-end</code> and
				...
				<div class="row">
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<p class="text-muted">
									Any single <code>.btn</code> can be turned into a dropdown toggle with some
									...
									<div class="col-auto">
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle drop-arrow-none"
												type="button" id="dropdownWithoutArrow" data-bs-toggle="dropdown"
									...
									<div class="col-auto">
										<div class="dropdown">
											<button class="btn btn-outline-info dropdown-toggle drop-arrow-none"
												type="button" id="dropdownMenuIcon" data-bs-toggle="dropdown"
												aria-haspopup="true" aria-expanded="false">
												Tabler Icon
											</button>
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">Trigger dropdown menus above elements by adding
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">Add a header to label sections of actions in any dropdown
									menu.
								</p>
								<!-- Header Item -->
								<div class="btn-group">
					...
					<div class="col-xl-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<p class="text-muted">Place any freeform text within a dropdown menu with text and
									use spacing utilities. Note that you’ll likely need additional sizing styles to
