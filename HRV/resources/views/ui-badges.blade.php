			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-xl mb-3">Use the <span class="text-secondary">badge</span> class to show
								a default badge.</p>
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-xl mb-3">Use the <code>badge-soft-</code> class to create a softer badge.
							</p>
							<div class="d-flex flex-wrap gap-2">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-xl mb-3">Use the <code>badge-outline-</code> to create a badge with the
								outline.</p>
							<div class="d-flex flex-wrap gap-2">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-xl mb-3">Use the <code>rounded-pill badge-outline-</code> class to create
								a outline pill badge.</p>
							<div class="d-flex flex-wrap gap-2">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-xl mb-3">Use the <code>badge-border</code> and <code>badge-soft-</code>
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="d-flex flex-wrap gap-2">
								<span
									class="badge rounded-pill badge-soft-primary border border-primary">Primary</span>
								<span
									class="badge rounded-pill badge-soft-secondary border border-secondary">Secondary</span>
								<span
									class="badge rounded-pill badge-soft-success border border-success">Success</span>
								<span
									class="badge rounded-pill badge-soft-danger border border-danger">Danger</span>
								<span
									class="badge rounded-pill badge-soft-warning border border-warning">Warning</span>
