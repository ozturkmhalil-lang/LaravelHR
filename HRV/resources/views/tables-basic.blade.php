										...
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													...
													<td><span class="badge rounded-pill badge-soft-success">Active</span>
													</td>
													<td>
														<div class="dropdown d-inline-block">
															<button type="button"
																class="drop-arrow-none btn btn-icon btn-outline-light btn-sm border-0"
																data-bs-toggle="dropdown" aria-haspopup="true"
																aria-expanded="false" aria-label="Row options">
												...
												<tr>
													...
													<td><span class="badge rounded-pill badge-soft-danger">Inactive</span>
													</td>
													<td>
														<div class="dropdown d-inline-block">
															<button type="button"
							...
							<div class="card">
								...
								<div class="card-body">
									<p class="card-title-desc">You can also invert the colors—with light text on dark
										backgrounds—with <code>.table-dark</code>.</p>
										...
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													...
													<td>Mark</td>
													<td>Otto</td>
													<td><button type="button" class="btn btn-light btn-sm">View</button>
													</td>
												</tr>
												<tr>
													<th scope="row">2</th>
										...
										<table class="table mb-0">
											...
											<tbody>
												<tr>
													<th scope="row">1</th>
													<td>
														<h6 class="mb-0 fs-14 fw-semibold"> #INV368967</h6>
													</td>
													<td>
														<div class="d-flex align-items-center">
													...
													<td><span
															class="badge badge-boxed  badge-outline-warning">Pending</span>
													</td>
													<td>
														<a href="javascript: void(0);" class="link-reset fs-18 p-1"> <i
												...
												<tr>
													...
													<td><span class="fw-semibold">$950</span></td>
													<td>
														<h6 class="mb-0 fs-14 fw-semibold">Cheque</h6>
													</td>
