				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<p><em>This line rendered as italicized text.</em></p> Nulla <abbr
								title="attribute">attr</abbr> vitae elit libero, a pharetra augue.
			...
			<div class="row">
				...
				<div class="col-xl-4">
					<div class="card">
						...
						<div class="card-body">
							<p class="text-muted"><strong>This only applies to immediate children list
									items</strong>, meaning you will need to add the class for any nested lists as
								well.</p>
							...
							<h5>Inline</h5>
							<p class="text-muted m-b-15">Place all list items on a single line with
				...
				<div class="col-xl-6">
					<div class="card card-h-100">
						...
						<div class="card-body">
							...
							<p class="text-muted m-b-15">Use text utilities as needed to change the alignment of
								your blockquote.</p>
							...
							<figure>
								<figcaption class="blockquote-footer text-end mb-0">Someone famous in <cite
										title="Source Title">Source Title</cite></figcaption>
							</figure>
						</div> <!-- end card body -->
					</div> <!-- end card -->
							...
							<dl class="row mb-0">
								...
								<dd class="col-sm-9 mb-0">
									<dl class="row mb-0">
										...
										<dd class="col-sm-8 mb-0">Aenean posuere, tortor sed cursus feugiat, nunc
