			...
			<ul class="nav-menu">
				...
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="{{url('employee-dashboard')}}"
								class="{{ Request::is('employee-dashboard') ? 'active' : '' }}">Employee Dashboard</a>
						</li>
						...
						<li><a href="{{url('it-admin-dashboard')}}"
								class="{{ Request::is('it-admin-dashboard') ? 'active' : '' }}">IT Admin Dashboard</a>
						</li>
						<li><a href="{{url('asset-dashboard')}}"
								class="{{ Request::is('asset-dashboard') ? 'active' : '' }}">Asset Dashboard</a></li>
						<li><a href="{{url('help-desk-dashboard')}}"
								class="{{ Request::is('help-desk-dashboard') ? 'active' : '' }}">Help Desk Dashboard</a>
						</li>
					</ul>
				</li>
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="{{url('packages')}}"
								class="{{ Request::is('packages', 'packages-grid') ? 'active' : '' }}">Packages</a></li>
						...
						<li class="submenu submenu-two">
							...
							<ul>
								...
								<li><a href="{{url('sla-policies')}}"
										class="{{ Request::is('sla-policies') ? 'active' : '' }}">SLA Policies</a></li>
				...
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="{{url('ai-payroll-forecast')}}"
								class="{{ Request::is('ai-payroll-forecast') ? 'active' : '' }}">AI Payroll Forecast</a>
						</li>
						<li><a href="{{url('ai-hiring-forecast')}}"
								class="{{ Request::is('ai-hiring-forecast') ? 'active' : '' }}">AI Hiring Forecast</a>
						</li>
				...
				<li class="submenu">
					...
					<ul>
						...
						<li><a href="{{url('todo')}}" class="{{ Request::is('todo', 'todo-list') ? 'active' : '' }}">To
								Do</a></li>
				...
				<li class="submenu">
					<a href="#"
						class="{{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-box', 'layout-horizontal-overlay', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? 'active subdrop' : '' }}">
				...
				<li class="submenu">
					...
					<ul>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li><a href="{{url('ticket-reports')}}"
										class="{{ Request::is('ticket-reports') ? 'active' : '' }}">Ticket Reports</a>
								</li>
							</ul>
						</li>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li><a href="{{url('work-from-home')}}"
										class="{{ Request::is('work-from-home') ? 'active' : '' }}">WFH Management</a>
								</li>
							</ul>
						</li>
						<li class="submenu">
						...
						<li><a href="{{url('notice-period-tracker')}}"
								class="{{ Request::is('notice-period-tracker') ? 'active' : '' }}"><span>Notice Period
									Tracker</span></a></li>
						<li><a href="{{url('promotion')}}"
								class="{{ Request::is('promotion') ? 'active' : '' }}"><span>Promotion</span></a></li>
						...
						<li class="submenu">
							...
							<ul>
								<li><a href="{{url('job-grid')}}"
										class="{{ Request::is('job-grid', 'job-list') ? 'active' : '' }}">Jobs</a></li>
								...
								<li><a href="{{url('resume-parsing')}}"
										class="{{ Request::is('resume-parsing') ? 'active' : '' }}">Resume Parsing</a>
								</li>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li><a href="{{url('task-report')}}"
										class="{{ Request::is('task-repor') ? 'active' : '' }}">Task Report</a></li>
				...
				<li class="submenu">
					<a href="#"
						class="{{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? 'active subdrop' : '' }}">
					...
					<ul>
						...
						<li><a href="{{url('profile-settings')}}"
								class="{{ Request::is('profile-settings') ? 'active' : '' }}">Profile Settings</a></li>
						<li><a href="{{url('gallery')}}"
								class="{{ Request::is('gallery') ? 'active' : '' }}">Gallery</a></li>
						<li><a href="{{url('search-result')}}"
								class="{{ Request::is('search-result') ? 'active' : '' }}">Search Results</a></li>
						...
						<li><a href="{{url('under-maintenance')}}"
								class="{{ Request::is('under-maintenance') ? 'active' : '' }}">Under Maintenance</a>
						</li>
						<li><a href="{{url('under-construction')}}"
								class="{{ Request::is('under-construction') ? 'active' : '' }}">Under Construction</a>
						</li>
						<li><a href="{{url('api-keys')}}" class="{{ Request::is('api-keys') ? 'active' : '' }}">API
								Keys</a></li>
						<li><a href="{{url('privacy-policy')}}"
								class="{{ Request::is('privacy-policy') ? 'active' : '' }}">Privacy Policy</a></li>
						<li><a href="{{url('terms-condition')}}"
								class="{{ Request::is('terms-condition') ? 'active' : '' }}">Terms & Conditions</a></li>
					</ul>
				</li>
				<li class="submenu">
					<a href="#">
