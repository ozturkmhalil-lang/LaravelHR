...
<div class="stacked-sidebar" id="stacked-sidebar">
    <div class="sidebar sidebar-stacked" style="display: flex !important;">
        ...
        <div class="sidebar-right d-flex justify-content-between flex-column">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <a href="#menu-application" role="tab"
                                    class="nav-link {{ Request::is('chat', 'voice-call', 'video-call', 'outgoing-call', 'incoming-call', 'call-history', 'calendar', 'email', 'email-reply', 'todo', 'todo-list', 'notes', 'social-feed', 'file-manager', 'kanban-view', 'invoices', 'add-invoices', 'edit-invoices', 'invoice-details') ? 'active' : '' }}"
                            ...
                            <div class="col-6">
                                <a href="#menu-aicenter" role="tab"
                                    ...
                                    title="Apps" data-bs-toggle="tab" data-bs-target="#menu-aicenter"
                                    aria-selected="false">
                            ...
                            <div class="col-6">
                                <a href="#menu-finance" role="tab"
                                    class="nav-link {{ Request::is('estimates', 'invoice', 'payments', 'expenses', 'provident-fund', 'taxes', 'categories', 'budgets', 'budget-expenses', 'budget-revenues', 'employee-salary', 'payslip', 'payroll', 'payroll-overtime', 'payroll-deduction') ? ' show active ' : '' }}"
                            ...
                            <div class="col-6">
                                <a href="#menu-authentication" role="tab"
                                    ...
                                    title="Authentication" data-bs-toggle="tab" data-bs-target="#menu-authentication"
                                    aria-selected="false">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade {{ Request::is('ai-attendance-insights', 'ai-payroll-forecast', 'ai-hiring-forecast', 'ai-team-performance-insights', 'ai-configuration') ? 'show active' : '' }}"
                            ...
                            <ul class="stack-submenu">
                                ...
                                <li><a href="{{url('ai-configuration')}}"
                                        class="{{ Request::is('ai-configuration') ? 'active' : '' }}">AI Settings</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <li class="submenu submenu-two">
                                    ...
                                    <ul>
                                        <li><a href="{{url('voice-call')}}"
                                                class="{{ Request::is('voice-call') ? 'active' : '' }}">Voice Call</a>
                                        </li>
                                        <li><a href="{{url('video-call')}}"
                                                class="{{ Request::is('video-call') ? 'active' : '' }}">Video Call</a>
                                        </li>
                        ...
                        <div class="tab-pane fade {{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-box', 'layout-horizontal-single', 'layout-horizontal-overlay', 'layout-horizontal-box', 'layout-horizontal-sidemenu', 'layout-vertical-transparent', 'layout-without-header', 'layout-rtl', 'layout-dark') ? ' show active' : '' }}"
                            ...
                            <ul class="stack-submenu">
                                ...
                                <li><a href="{{url('layout-modern')}}"
                                        class="{{ Request::is('layout-modern') ? 'active' : '' }}">Modern</a></li>
                                <li><a href="{{url('layout-two-column')}}"
                                        class="{{ Request::is('layout-two-column') ? 'active' : '' }}">Two Column</a>
                                </li>
                                <li><a href="{{url('layout-hovered')}}"
                                        class="{{ Request::is('layout-hovered') ? 'active' : '' }}">Hovered</a></li>
                                <li><a href="{{url('layout-box')}}"
                                        class="{{ Request::is('layout-box') ? 'active' : '' }}">Boxed</a></li>
                                <li><a href="{{url('layout-horizontal-single')}}"
                                        class="{{ Request::is('layout-horizontal-single') ? 'active' : '' }}">Horizontal
                                        Single</a></li>
                                <li><a href="{{url('layout-horizontal-overlay')}}"
                                        class="{{ Request::is('layout-horizontal-overlay') ? 'active' : '' }}">Horizontal
                                        Overlay</a></li>
                                <li><a href="{{url('layout-horizontal-box')}}"
                                        class="{{ Request::is('layout-horizontal-box') ? 'active' : '' }}">Horizontal
                                        Box</a></li>
                                <li><a href="{{url('layout-horizontal-sidemenu')}}"
                                        class="{{ Request::is('layout-horizontal-sidemenu') ? 'active' : '' }}">Menu
                                        Aside</a></li>
                                <li><a href="{{url('layout-vertical-transparent')}}"
                                        class="{{ Request::is('layout-vertical-transparent') ? 'active' : '' }}">Transparent</a>
                                </li>
                                <li><a href="{{url('layout-without-header')}}"
                                        class="{{ Request::is('layout-without-header') ? 'active' : '' }}">Without
                                        Header</a></li>
                        ...
                        <div class="tab-pane fade {{ Request::is('clients-grid', 'projects-grid', 'projects', 'project-details', 'tasks', 'task-board') ? 'show active ' : '' }}"
                            ...
                            <ul class="stack-submenu">
                                <li><a href="{{url('clients-grid')}}"
                                        class="{{ Request::is('clients-grid') ? 'active' : '' }}"><span>Clients</span></a>
                                </li>
                                <li class="submenu">
                                ...
                                <li class="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="{{url('blog-tags')}}"
                                                class="{{ Request::is('blog-tags') ? 'active' : '' }}">Tags</a></li>
                                    </ul>
                                </li>
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                        ...
                        <div class="tab-pane fade {{ Request::is('starter', 'profile', 'gallery', 'search-result', 'timeline', 'pricing', 'coming-soon', 'under-maintenance', 'under-construction', 'api-keys', 'privacy-policy', 'terms-condition') ? ' show active' : '' }}"
                            ...
                            <ul class="stack-submenu">
                                <li><a href="{{url('starter')}}"
                                        class="{{ Request::is('starter') ? 'active' : '' }}">Starter</a></li>
                                <li><a href="{{url('profile')}}"
                                        class="{{ Request::is('profile') ? 'active' : '' }}">Profile</a></li>
                                <li><a href="{{url('profile-settings')}}"
                                        class="{{ Request::is('profile-settings') ? 'active' : '' }}">Profile
                                        Settings</a></li>
                                <li><a href="{{url('gallery')}}"
                                        class="{{ Request::is('gallery') ? 'active' : '' }}">Gallery</a></li>
                                <li><a href="{{url('search-result')}}"
                                        class="{{ Request::is('search-result') ? 'active' : '' }}">Search Results</a>
                                </li>
                                <li><a href="{{url('timeline')}}"
                                        class="{{ Request::is('timeline') ? 'active' : '' }}">Timeline</a></li>
                                ...
                                <li><a href="{{url('under-maintenance')}}"
                                        class="{{ Request::is('under-maintenance') ? 'active' : '' }}">Under
                                        Maintenance</a></li>
                                <li><a href="{{url('under-construction')}}"
                                        class="{{ Request::is('under-construction') ? 'active' : '' }}">Under
                                        Construction</a></li>
                                <li><a href="{{url('api-keys')}}"
                                        class="{{ Request::is('api-keys') ? 'active' : '' }}">API Keys</a></li>
                        ...
                        <div class="tab-pane fade {{ Request::is('ui-alerts', 'ui-accordion', 'ui-avatar', 'ui-badges', 'ui-buttons', 'ui-buttons-group', 'ui-breadcrumb', 'ui-cards', 'ui-carousel', 'ui-dropdowns', 'ui-grid', 'ui-images', 'ui-modals', 'ui-offcanvas', 'ui-pagination', 'ui-popovers', 'ui-progress', 'ui-placeholders', 'ui-spinner', 'ui-nav-tabs', 'ui-toasts', 'ui-tooltips', 'ui-typography', 'ui-collapse', 'ui-links', 'ui-list-groups', 'ui-ratio', 'ui-clipboard', 'ui-dragula', 'ui-sweetalerts', 'ui-lightbox', 'ui-scrollbar', 'form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2', 'tables-basic', 'data-tables', 'chart-apex', 'chart-js', 'chart-morris', 'chart-flot', 'chart-c3', 'icon-fontawesome', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag') ? 'active subdrop' : '' }}"
                            ...
                            <ul class="stack-submenu">
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('form-basic-inputs', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload', 'form-horizontal', 'form-vertical', 'form-floating-labels', 'form-validation', 'form-wizard', 'form-select2') ? 'subdrop active' : '' }}">Forms<span
                                            class="menu-arrow"></span> </a>
                                    <ul>
                                        <li class="submenu submenu-two">
                                            <a href="javascript:void(0);"
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('tables-basic', 'data-tables') ? 'subdrop active' : '' }}">Tables<span
                                            class="menu-arrow"></span></a>
                                    <ul>
            ...
            <div class="p-3">
                <a href="https://smarthr.dreamstechnologies.com/laravel/documentation/index.html"
                    class="d-flex align-items-center fs-12 mb-3" targer="_blank">Documentation</a>
                <a href="https://smarthr.dreamstechnologies.com/laravel/documentation/changelog.html"
                    class="d-flex align-items-center fs-12" targer="_blank">Change Log<span
                        class="badge bg-pink badge-xs text-white fs-10 ms-2">v2.0.1</span></a>
            </div>
        </div>
    </div>
</div>
