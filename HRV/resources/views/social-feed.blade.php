									...
									<div>
										<div class="more-menu-3">
											<a href="javscript:void(0);"
												...
												<span class="btn btn-icon btn-sm"><i
														class="ti ti-thumb-down"></i></span>
											</a>
										</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-center mb-3">
									...
									<div class="swiper-nav custom-nav nav-control">
										<div class="swiper-button-prev"></div>
										<div class="swiper-button-next"></div>
									</div>
								</div>
								<div class="swiper channels-slider">
							...
							<div class="card-body">
								<div class="mb-2">
									<p class="text-dark fw-medium">"Believe in yourself and all that you are. Know
										...
										<a href="javascript:void(0);"
											class="text-info link-hover">#MotivationMonday</a>
								...
								<div class="swiper social-gallery-slider mb-3">
									<div class="swiper-wrapper">
									<div class="swiper-slide">
										<a href="{{URL::asset('build/img/social/gallery-big-01.jpg')}}" class="glightbox gallery-item" data-gallery="gallery-group">
									...
									<div class="swiper-slide">
										<a href="{{URL::asset('build/img/social/gallery-big-02.jpg')}}" class="glightbox gallery-item" data-gallery="gallery-group">
									...
									<div class="swiper-slide">
										<a href="{{URL::asset('build/img/social/gallery-big-03.jpg')}}" class="glightbox gallery-item" data-gallery="gallery-group">
									...
									<div class="swiper-slide">
										<a href="{{URL::asset('build/img/social/gallery-big-04.jpg')}}" class="glightbox gallery-item" data-gallery="gallery-group">
								...
								<div class="d-flex align-items-start">
									<a href="javascript:void(0);"
										class="avatar avatar-rounded me-2 flex-shrink-0"><img
							...
							<div class="card-body">
								...
								<div class="card shadow-none mb-3">
									...
									<div class="card-body p-2">
										<h6 class="mb-1 text-truncate"><a href="javascript:void(0);">Drinking water
							...
							<div class="card-body">
								...
								<div class="d-flex align-items-start mb-3">
									...
									<div class="bg-light rounded flex-fill p-2">
										...
										<p class="mb-1">Congratulations on the launch! I've been eagerly waiting for
											this
						...
						<div class="card-body">
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="pills-home" role="tabpanel">
									...
									<div>
										<a href="javascript:void(0);"
											class="btn btn-outline-light w-100 border">View All <i
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="bg-light-500 rounded p-2 mb-2">
								...
								<p class="text-dark fw-medium"><a href="javascript:void(0);">Beyond capital gains
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="d-flex align-items-center flex-wrap gap-1">
								<a href="javascript:void(0);"
									class="text-info d-inline-flex link-hover">#HealthTips</a>
								<a href="javascript:void(0);"
									class="text-info d-inline-flex link-hover">#Wellness</a>
								<a href="javascript:void(0);"
									class="text-info d-inline-flex link-hover">#Motivation</a>
								<a href="javascript:void(0);"
									class="text-info d-inline-flex link-hover">#Inspiration </a>
							</div>
						</div>
					</div>
					<div class="card">
						<div class="card-body">
							...
							<h6 class="text-center"><a href="javascript:void(0);">Enjoy Unlimited Access on a small
									price monthly.</a></h6>
							<div class="mt-3">
								<a href="javascript:void(0);" class="btn btn-outline-light w-100 border">Upgrade Now
